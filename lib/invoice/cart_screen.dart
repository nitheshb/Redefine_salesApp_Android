                              ...
                              child: Center(
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "₹${pillarTotalCost + beamTotalCost + boxPillarTotalCost} ",
...
// 72 = 72/10 =.toInt = 7 and module will give
              ...
              if (cartList.contains(myGoalList['beamsList']?[0]['qty'])) {
                setState(() {
                  myGoalList['beamsList']?[0]['qty'] =
                      (int.parse(goalBeamText.text) / 10).toInt();
                });
